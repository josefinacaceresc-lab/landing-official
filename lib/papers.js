...
// 8 doctoral papers — author: Dra. Josefina Cáceres, Ph.D.(c), 2024.
...
export const papers = [
  {
    ...
    keyFindings: [
      ...
      'La integración DBT + Schema Therapy + monitoreo computacional define un nuevo estándar de Fidelidad Total.',
    ],
    words: 6454,
    references: 33,
    date: '2024',
  ...
  },
  {
    ...
    abstract:
      'Metodologías de evaluación en tiempo real para el monitoreo de estados emocionales en contextos clínicos. Revisión sistemática de protocolos EMA aplicados a poblaciones TLP, con propuesta de implementación local vía LaKaira AI.',
    keyFindings: [
    ...
    references: 22,
    date: '2024',
    keywords: ['EMA', 'monitoreo ecológico', 'DBT', 'LaKaira', 'phenotyping digital'],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    abstract:
      'Aplicaciones de machine learning para la predicción de crisis emocionales y conductas-objetivo en TLP. Marco ético y técnico para la implementación de LaKaira AI en el Instituto DBT Chile.',
    keyFindings: [
    ...
    references: 20,
    date: '2024',
    keywords: ['IA', 'machine learning', 'LaKaira AI', 'predicción de crisis', 'ética clínica'],
  },
]
