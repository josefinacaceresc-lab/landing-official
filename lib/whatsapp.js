...
export function isBusinessHoursSantiago() {
  // ⚠️ TEMP DEMO OVERRIDE (June 19 2026) — Dra. Cáceres preview request
  // Forces business-hours UI to TRUE so the modal shows the "En línea ·
  // Karina disponible" state regardless of actual Santiago time.
  // 🔁 REVERT THIS by removing the `return true` line below.
  return true
