...
export function getOrganizationSchema() {
  return {
    ...
    description: 'Centro especializado en Terapia Dialéctico Conductual (DBT) y tratamiento de Trastorno Límite de Personalidad. Participación internacional en investigación WDBTA (Barcelona 2023 · Amberes 2024).',
