...
export default function sitemap() {
  ...
  const staticRoutes = [
    ...
    { url: `${BASE}/trastornos-de-personalidad`, lastModified: now, changeFrequency: 'weekly', priority: 0.98 },
    ...
    { url: `${BASE}/evaluacion-psiquiatrica`, lastModified: now, changeFrequency: 'monthly', priority: 0.95 },
