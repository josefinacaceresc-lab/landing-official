...
export const metadata = {
  ...
  authors: [{ name: 'Josefina Cáceres Cortés', url: 'https://institutodbtchile.cl' }],
  alternates: {
    canonical: URL,
  },
  openGraph: {
    ...
    description: 'Preprint de Josefina Cáceres Cortés · Instituto DBT Chile · NexaryaLabs · 2026 · DOI 10.5281/zenodo.21346541',
    url: URL,
