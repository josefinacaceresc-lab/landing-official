...
Tanto la persona con TLP como su entorno cercano pueden beneficiarse de orientación clínica. **No es necesario esperar a una crisis para pedir ayuda.**`,
  },
  {
    ...
    autor: 'Dra. Josefina Cáceres Cortés, Ph.D.(c)',
...
- Linehan, M. M. (1993). *Cognitive-Behavioral Treatment of Borderline Personality Disorder*. Guilford Press.`
  },
  {
    ...
    resumen: 'La DBT-SUD es la adaptación de la Terapia Dialéctico Conductual para el tratamiento de adicciones con desregulación emocional, trauma y conducta suicida. Instituto DBT Chile (antes DBT Chile) es pionero en implementar este modelo con fidelidad en el país.',
