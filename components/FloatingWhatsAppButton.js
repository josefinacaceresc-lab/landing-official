...
export default function FloatingWhatsAppButton() {
  ...
  return (
    ...
    >
      <span className="relative flex items-center justify-center w-12 h-12 rounded-full bg-white border border-gray-300 hover:border-primary text-gray-700 hover:text-primary shadow-sm hover:shadow-md transition-all">
